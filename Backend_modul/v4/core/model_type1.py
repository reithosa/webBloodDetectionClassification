...
class Statistics_image(Base):
    ...
    relation_images: Mapped["Images"] = relationship("Images", back_populates="relation_statistics")

class Labels(Base):
    __tablename__="labels"
    __table_args__ = (
        CheckConstraint("cls IN ('basophil','eosinophil','erythrocyte','lymphocyte','monocyte','neutrophil','platelet')"), 
    )
