...
from v4.config.paths import APP_PATH, TEMPLATES_PATH, IMAGES_PATH, STYLE_PATH, JS_PATH
from v4.core.conn import conn
from v4.core.queries import get_image_path_id, get_image_labels, delete_image, delete_labels, uploud_labels_frontend
...
@images_router.post('/{file_name}/save')
